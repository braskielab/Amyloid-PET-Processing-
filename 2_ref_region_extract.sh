...
#STAGE 2 - EXTRACT REFERENCE REGION 
...
cmd="${FSLMATHS} ${PET_OUT}/${subj}_aparc+aseg_native_ref_${rr}.nii.gz -thr 0.5 -bin ${PET_OUT}/${subj}_aparc+aseg_native_ref_${rr}_bin.nii.gz"
eval ${cmd}
touch ${NOTE}
echo -e "[[Stage 2: Step 2]]\r\n Command --> ${cmd}\r\n" >> ${NOTE}
